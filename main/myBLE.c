...
#define SAMPLE_DEVICE_NAME          "ESP_GATTS1"
    ...
    switch (event) {
        case ESP_GATTS_REG_EVT:{
            ...
            if (create_attr_ret){
       	    ...
       	    break;
       	    case ESP_GATTS_ADD_CHAR_EVT: //renux2
       	    ESP_LOGI(GATTS_TABLE_TAG, "fucking adddddd char");
        ...
        case ESP_GATTS_CONNECT_EVT:
            ...
            conn_handle=param->connect.conn_id;//renux1
            ESP_LOGI(GATTS_TABLE_TAG, "renux %d & %d", param->connect.conn_id,conn_handle);
